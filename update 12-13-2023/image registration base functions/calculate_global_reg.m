function [imout,tform,cent,f,Rout]=calculate_global_reg(imrf,immv,rf,iternum,IHC)
if IHC==1;bb=0.8;else;bb=0.9;end
% calculates global registration of a pair of greyscale, downsampled histological images.
